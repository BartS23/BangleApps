...
const screens = [
    ...
    { name: "Test4", bgColor: "#ff0", color: "#fff" },
    { name: "Test5", bgColor: "#00f", color: "#fff" },
    { name: "Test6", bgColor: "#f0f", color: "#fff" },
    { name: "Test7", bgColor: "#0ff", color: "#fff" },
    { name: "Test8", bgColor: "#fff", color: "#000" },
];
